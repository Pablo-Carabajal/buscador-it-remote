...
class Config:
    ...
    RUTA_EMPRESAS_LOCALES = BASE_DIR / os.getenv("RUTA_EMPRESAS_LOCALES", "data/tech_companies.json")
    ...
    CATEGORIAS = [c.strip() for c in os.getenv("CATEGORIAS_IT", "").split(",") if c.strip()]
